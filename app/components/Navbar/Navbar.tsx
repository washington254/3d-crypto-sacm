                ...
                <div className="mx-auto max-w-7xl p-3 md:p-4 lg:px-8">
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <button className='hidden lg:flex justify-end text-xl font-semibold py-4 px-6 lg:px-12 navbutton text-white'>Get Scammed</button>
                            {/* <Contactusform /> */}
                        </div>
                        ...
                        <div className='block lg:hidden'>
                            <div className="block h-6 w-6 text-white" aria-hidden="true" onClick={() => setIsOpen(true)}> X</div>
                        </div>
