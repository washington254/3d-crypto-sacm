...
const tableData: table[] = [
    ...
    {
        index: 3,
        name: "Follow the goddamn train cj",
    ...
    {
        index: 4,
        name: "Mia probably did it with razor",
        ...
        <>
            <div className='mx-auto max-w-7xl pt-40 px-6' id="exchange-section">
                <div className="table-b bg-navyblue p-8 overflow-x-auto">
                    <h3 className="text-offwhite text-2xl">Look at our list of shitcoins. we guarantee to dump all of it on you</h3>
